...
export class Convert {
    public static toGeneralInfo(json: string): GeneralInfo {
        return cast(JSON.parse(json), r("GeneralInfo"));
    }

    public static generalInfoToJson(value: GeneralInfo): string {
        return JSON.stringify(uncast(value, r("GeneralInfo")), null, 2);
    }
}
